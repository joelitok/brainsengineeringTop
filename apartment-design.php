                                            ...
                                            <nav id="menu" class="menu">
                                                <ul class="dropdown">
                                                   ...
                                                   <li class="active"><a href="#">Services</a>
                                                        <ul>
                                                            <li class="active"><a href="apartment-design.php">Apartment Design</a></li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box">
                            <div class="page-title-heading">
                                <h1 class="title">Apartment Design</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span><span>Apartment Design</span></span>
                            </div>
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                    ...
                    <div class="col-lg-8 content-area order-1 order-lg-2">
                        ...
                        <div class="cmt-service-single-content-area">
                            ...
                            <div class="cmt-service-description">
                                <h4 class="mb-10">Apartment Design</h4>
                                <div class="mb-30">
