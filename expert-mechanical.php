                                                ...
                                                <ul class="dropdown">
                                                   ...
                                                   <li class="active"><a href="#">Services</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="expert-mechanical.php">Expert Mechanical</a></li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box">
                            <div class="page-title-heading">
                                <h1 class="title">Expert Mechanical</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span><span>Expert Mechanical</span></span>
                            </div>
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                    ...
                    <div class="col-lg-8 content-area order-1 order-lg-2">
                        ...
                        <div class="cmt-service-single-content-area">
                            ...
                            <div class="cmt-service-description">
                                <h4 class="mb-10">Expert Mechanical</h4>
                                <div class="mb-30">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <!--featured-icon-box-->
                                        <div class="featured-icon-box style8 text-left">
                                            <div class="featured-icon"><!--featured-icon-->
                                                <div class="cmt-icon cmt-icon_element-border cmt-icon_element-color-grey cmt-icon_element-size-xs cmt-icon_element-style-round">
                                            ...
                                            <div class="featured-content"><!--featured-content-->
                                                ...
                                                <div class="featured-desc"><!--featured-desc-->
                                                    <p>Lorem ipsum dolor sit amet consecte tur adipiscing elitsed do.</p>
                                                </div>
                                            </div>
