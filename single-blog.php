                                                   ...
                                                   <li><a href="#">Services</a>
                                                    ...
                                                    <li class="active"><a href="#">Blog</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="single-blog.php">Single Blog View</a></li>
                                                        </ul>
                                                    </li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span><span>Single Blog</span></span>
                            </div>
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                ...
                <div class="row">
                        ...
                        <article class="post cmt-blog-single">
                            ...
                            <div class="post-featured-wrapper mb-40">
                                <div class="post-featured">
                                    <img class="img-fluid" src="images/blog/blog-09.jpg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="cmt-blog-single-content">
                                <div class="entry-content">
                                    <div class="post-meta mb-20"><!-- post-meta -->
                                        <span class="cmt-meta-line comments-link"><i class="fa fa-calendar cmt-textcolor-skincolor"></i> June 9, 2021</span>
                                        <span class="cmt-meta-line byline"><i class="ti ti-user cmt-textcolor-skincolor"></i> Admin</span>
                                        <span class="cmt-meta-line comments-link"><i class="fa fa-comments-o cmt-textcolor-skincolor"></i> (3)</span>
                                        <span class="cmt-meta-line byline"><i class="fa fa-tags cmt-textcolor-skincolor"></i> Entertainment, Technology</span>
                                    </div>
                                    <div class="cmt-box-desc-text">
                                        <p class="mb-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vestibulum lorem sed risus ultricies tristique nulla. Sem viverra aliquet eget sit amet tellus cras adipiscing. Varius sit amet mattis vulputate enim nulla. Elit ullamcorper dignissim cras tincidunt. Convallis aenean et tortor at risus viverra adipiscing at in.</p>
                                        <p class="mb-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vestibulum lorem sed risus ultricies tristique nulla. Sem viverra aliquet eget sit amet tellus cras adipiscing. Varius sit amet mattis vulputate enim nulla. </p>
                                        ...
                                        <p class="mb-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vestibulum lorem sed risus ultricies tristique nulla. Sem viverra aliquet eget sit amet tellus cras adipiscing. Varius sit amet mattis vulputate enim nulla. </p>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-30"><img class="img-fluid" src="images/blog/blog-10.jpg" alt="blog-image"></div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-30"><img class="img-fluid" src="images/blog/blog-11.jpg" alt="blog-image"></div>
                                            </div>
                                        </div>
                                        <p class="mb-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vestibulum lorem sed risus ultricies tristique nulla. Sem viverra aliquet eget sit amet tellus cras adipiscing. Varius sit amet mattis vulputate enim nulla. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s Lorem Ipsum is simply dummy text of the printing .Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                    ...
                                    <div id="comments" class="comments-area">
                                        <h2 class="comments-title">Comment  ( 2 )</h2>
                                                ...
                                                <div class="comment-body">
                                                    ...
                                                    <div class="comment-box">
                                                        <div class="comment-meta commentmetadata">
                                                            <cite class="cmt-comment-owner">Alex</cite>
                                                            <a href="#">February 14, 2021 at 8:41 am</a>
                                                        </div>
                                                ...
                                                <div class="comment-body">
                                                    ...
                                                    <div class="comment-box">
                                                        <div class="comment-meta">
                                                            <cite class="cmt-comment-owner">Cherieh</cite>
                                                            <a href="#">February 14, 2021 at 8:42 am</a>
                                                        </div>
                                                        <div class="author-content-wrap">
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium eius, sunt porro corporis maiores ea, voluptatibus omnis maxime</p>
                                                        </div>
                    ...
                    <div class="col-lg-4 widget-area sidebar-right">
                        ...
                        <aside class="widget widget-categories">
                            ...
                            <ul class="">
                                <li><i class="fa fa-square-o"></i><a href="#">Manufacturing</a>
                                </li>
                                <li><i class="fa fa-square-o"></i><a href="#">Chemical Research</a>
                                </li>
                                <li><i class="fa fa-square-o"></i><a href="#">Mechanical</a>
                                </li>
                                <li><i class="fa fa-square-o"></i><a href="#">Building Management</a>
                                </li>
                                <li><i class="fa fa-square-o"></i><a href="#">Electronic Materials</a>
                                </li>
                            </ul>
                        </aside>
                        <aside class="widget widget_post">
                            ...
                            <ul class="cmt-recent-post-list">
                                ...
                                <li>
                                    ...
                                    <span class="post-date clearfix">july 23, 2021</span>
                                </li>
                                <li>
                                    <a href="#"><img src="images/blog/post-06.jpg" alt="post-01"></a>
                                    <h5><a href="single-blog.php">Best factory award of the year 2018</a></h5>
                                    <span class="post-date clearfix">may 15, 2021</span>
                                </li>
                            </ul>
                        </aside>
