                    ...
                    <div class="cmt-topbar-content">
                        ...
                        <div class="topbar-right text-right">
                            <ul class="top-contact">
                                <li><strong class="cmt-textcolor-darkgrey"><i class="fa fa-phone"></i>Talk To Expert :</strong> <span class="tel-no">0 123-456-7890</span></li>
                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="active"><a href="#">Header Styles</a>
                                                            <ul>
                                                                ...
                                                                <li class="active"><a target="_blank" href="header-style-03.php">Header Style 03</a></li>
            ...
            <div id="rev_slider_5_1" class="rev_slider fullwidthabanner" data-version="5.4.8.1">
                <ul>
                    ...
                    <li data-index="rs-1" data-transition="slotslide-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" >
                        ...
                        <img src="images/slides/slider-mainbg-001.jpg" alt="" title="slider-mainbg-001" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    ...
                    <li data-index="rs-2" data-transition="slotslide-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <img src="images/slides/slider-mainbg-002.jpg" alt="" title="slider-mainbg-002" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
    ...
    <div class="site-main">
        ...
        <section class="cmt-row project-section clearfix">
            <div class="container">
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-3">
                                <div class="featured-icon-box style4 text-left">
                                    ...
                                    <a class="cmt-btn cmt-btn-size-sm cmt-btn-color-darkgrey btn-inline mt-15 cmt-btn-underline" href="#">READ MORE</a>
                                </div>
                            </div>
                            <div class="col-md-3">
                ...
                <!-- row-->
                <div class="row mt-35 res-991-mt-15">
                    <div class="col-md-12 text-center">
                        <p class="mb-0">Don’t hesitate, contact us for better help and services.<strong><u><a href="#" class="cmt-textcolor-darkgrey"> Explore all services</a></u></strong></p>
                    </div>
                </div>
            </div>
        </section>
        <!--project-section-->
        <!--broken-section-->
        <section class="cmt-row broken-section experience-section z-1 position-relative clearfix">
            <div class="container">
                <div class="row row-equal-height no-gutters">
                    ...
                    <div class="col-lg-7 col-sm-12">
                        <div class="spacing-3 box-shadow cmt-bgcolor-white">
                            ...
                            <p>Manufactoriuring industry became a key sector of production and labour in and North American countries during the Industrial Revolution, upsetting mercantile and feudal economies.The argumf something like this</p>
                            <!-- row-->
                            <div class="row no-gutters mb-20 mt-20">
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <ul class="cmt-list cmt-list-style-icon">
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Routine and medical care</span></li>
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content"> Building a healthy environment.</span></li>
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content"> Excellence in Healthcare every.</span></li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <ul class="cmt-list cmt-list-style-icon">
        ...
        <!--broken-section end-->
        <!--fid-left-section-->
        <section class="cmt-row fid-left-section cmt-bgcolor-darkgrey cmt-bg cmt-bgimage-yes bg-img5 clearfix">
                ...
                <div class="row"><!-- row -->
                    <div class="col-sm-12 col-md-12 col-lg-7">
                        <div class="pb-55 res-991-pb-0">
                            ...
                            <div class="cmt-video-icon cmt-left-video-icon ttm_prettyphoto mt-45 res-991-mt-30">
                                ...
                                <a href="https://youtu.be/7e90gBu4pas" class="ml-15 ttm_prettyphoto">See Our Video</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-5">
                        <div class="box-shadow spacing-4 cmt-bgcolor-white skin-border with-top-border">
                            <!-- section title -->
                            <div class="section-title clearfix">
                                <div class="title-header">
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <ul class="cmt-list cmt-list-style-icon">
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Expert &amp; Profesional</span></li>
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content"> 24x7 Emergency</span></li>
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">High Quality Work</span></li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <ul class="cmt-list cmt-list-style-icon">
        ...
        <section class="cmt-row team-section style1 clearfix">
            <div class="container">
                ...
                <!-- row -->
                <div class="row">
                    <div class="team-slide owl-carousel owl-theme owl-loaded" data-item="3" data-nav="false" data-dots="false" data-auto="true">
                        ...
                        <div class="spacing-5 cmt-bgcolor-white cmt-bg col-bg-img-two cmt-col-bgimage-yes box-shadow">
                            ...
                            <div class="layer-content">
                                ...
                                <form id="cmt-quote-form" class="row cmt-quote-form clearfix" method="post" action="#">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input name="phone" type="text" value="" placeholder="Zip Code" required="required" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
