    ...
    <div class="site-main">
        ...
        <section class="error-404">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="cmt-big-icon cmt-textcolor-skincolor">
                        ...
                        <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-square cmt-btn-style-border cmt-btn-color-darkgrey mb-15" href="index.php">Back To Home</a>
                    </div>
                </div>
            </div>
        </section>
