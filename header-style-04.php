...
<body>
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    <div class="site-navigation-content d-xl-flex flex-row">
                                        ...
                                        <nav id="menu" class="menu">
                                            <ul class="dropdown">
                                               <li class="active has-submenu"><a href="#">Home</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active has-submenu"><a href="#">Header Styles</a>
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li class="active"><a target="_blank" href="header-style-04.php">Header Style 04</a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </li>
                                               ...
                                               <li class="has-submenu"><a href="#">Services</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="architectural-design.php">Architectural Design</a></li>
    ...
    <div class="site-main">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="cmt-play-icon cmt-center-video-icon style1">
                            <div class="cmt-play-icon-animation">
                                <div class="cmt-icon cmt-icon_element-fill cmt-icon_element-color-skincolor cmt-icon_element-background-color-white cmt-icon_element-size-md cmt-icon_element-style-round">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="res-991-mt-30">
                            ...
                            <p>Manufactoriuring industry became a key sector of production and labour and North American countries during the Industrial Revolution, upsetting mercantile and feudal ecoan countries during the Industrial Revolution, mercantile and feudal economies.</p>
                            <p>Aenean tincidunt id mauris id auctor. an countries during the Industrial mercantile and feudal economies.
                            </p>
                            <div class="row no-gutters mb-20 mt-20"><!-- row-->
                                <div class="col-sm-12">
                                    <ul class="cmt-list cmt-list-style-icon">
                                        <li><i class="icon-circle-empty cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Our power of choice is untrammelled.</span></li>
                                        <li><i class="icon-circle-empty cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Able to do what we like best</span></li>
                                        <li><i class="icon-circle-empty cmt-textcolor-skincolor"></i><span class="cmt-list-li-content"> The obligations of business holds.</span></li>
                                    </ul>
                                </div>
                            </div><!-- row end-->
                            <div class="row">
                                <div class="col-sm-4 col-md-3 col-lg-4">
                                    <h5 class="mb-0">John Martin</h5>
                                    <p class="cmt-textcolor-skincolor font-sz-13">Chairman &amp; Founder</p>
                                </div>
                                <div class="col-sm-4 col-md-3 col-lg-4">
                                    <img src="images/author-sign.png" alt="author">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!--about-section end-->
        <!--service-section-->
        <section class="cmt-row service-section style3 bg-img9 clearfix">
            <div class="container">
                <div class="row"><!-- row -->
                    ...
                    <div class="services-slide owl-carousel" data-item="3" data-nav="false" data-dots="false" data-auto="false">
                        ...
                        <div class="featured-imagebox featured-imagebox-services">
                            ...
                            <div class="featured-content featured-content-services box-shadow">
                                ...
                                <div class="services-icon-box">
                                    <a href="general-contracting"><i class="ti ti-plus"></i></a>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                    </div>
        ...
        <section class="cmt-row broken-section clearfix">
            <div class="container">
                <div class="row no-gutters"><!-- row -->
                    <div class="col-lg-6 col-sm-12">
                        <div class="col-bg-img-five cmt-col-bgimage-yes cmt-bg cmt-left-span cmt-bgcolor-darkgrey spacing-7">
                            ...
                            <div class="layer-content">
                                ...
                                <p>We have a long and proud history givin emphasis to environment social and economic outcomes to deliver places that respond. Lorem ipsum dolor sit amet, consectetur adipisicing elit.s</p>
                                <div class="row">
                                    <div class="col-sm-10 col-md-6 col-lg-12 pt-30 res-991-pt-10">
                                        <!-- cmt-progress-bar -->
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <!-- col-bg-img-four -->
                        <div class="col-bg-img-four cmt-right-span cmt-col-bgimage-yes res-991-h-auto cmt-bg spacing-8 z-0">
                            <div class="cmt-col-wrapper-bg-layer cmt-bg-layer">
                            </div>
                            <div class="layer-content">
                            </div>
                        </div>
                        <img src="images/bg-image/col-bgimage-4.jpg" class="cmt-equal-height-image" alt="bg-image">
                    </div>
                </div><!-- row end-->
            </div>
        </section><!--best-company-section-->
        <!--portfolio-section-->
        <section class="cmt-row portfolio-section style2 position-relative z-1 clearfix">
            <div class="container">
                <div class="row"><!-- row -->
                    <div class="col-md-2 col-lg-3"></div>
                    <div class="col-sm-12 col-md-8 col-lg-6">
                            ...
                            <div class="cmt-box-view-overlay cmt-portfolio-box-view-overlay">
                                <div class="cmt-box-view-content-inner">
                                    <div class="cmt-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="portfolio-img" href="images/portfolio/08.jpg" data-rel="prettyPhoto" tabindex="0"><i class="fa fa-search"></i></a>
                                    </div>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            ...
                            <div class="cmt-box-view-overlay cmt-portfolio-box-view-overlay">
                                <div class="cmt-box-view-content-inner">
                                    <div class="cmt-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="portfolio-img" href="images/portfolio/09.jpg" data-rel="prettyPhoto" tabindex="0"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="featured-content">
                                        <div class="category">
                                            <p>textures</p>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            ...
                            <div class="cmt-box-view-overlay cmt-portfolio-box-view-overlay">
                                <div class="cmt-box-view-content-inner">
                                    <div class="cmt-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="portfolio-img" href="images/portfolio/10.jpg" data-rel="prettyPhoto" tabindex="0"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="featured-content">
                                        <div class="category">
                                            <p>exterior</p>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            ...
                            <div class="cmt-box-view-overlay cmt-portfolio-box-view-overlay">
                                <div class="cmt-box-view-content-inner">
                                    <div class="cmt-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="portfolio-img" href="images/portfolio/11.jpg" data-rel="prettyPhoto" tabindex="0"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="featured-content">
                                        <div class="category">
                                            <p>exterior</p>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            ...
                            <div class="cmt-box-view-overlay cmt-portfolio-box-view-overlay">
                                <div class="cmt-box-view-content-inner">
                                    <div class="cmt-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="portfolio-img" href="images/portfolio/12.jpg" data-rel="prettyPhoto" tabindex="0"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="featured-content">
                                        <div class="category">
                                            <p>mechanical</p>
                    ...
                    <div class="cmt-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            ...
                            <div class="cmt-box-view-overlay cmt-portfolio-box-view-overlay">
                                <div class="cmt-box-view-content-inner">
                                    <div class="cmt-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="portfolio-img" href="images/portfolio/13.jpg" data-rel="prettyPhoto" tabindex="0"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="featured-content">
                                        <div class="category">
                                            <p>mechanical</p>
                    ...
                    <div class="col-lg-9 offset-lg-3">
                        ...
                        <div class="section-title row-title clearfix">
                            ...
                            <ul class="list-inline">
                                <li>Technologies <i class="ti ti-layout-width-full"></i></li>
                                <li>Industries <i class="ti ti-layout-width-full"></i></li>
                                <li>Factory</li>
                            </ul>
                            <div class="mt-45">
                                <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-square cmt-btn-style-border cmt-btn-color-white" href="#">Read More</a>
                                <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-square cmt-btn-bgcolor-skincolor ml-15" href="#">Contact Us</a>
                            </div>
                        </div><!-- section title end -->
                    </div>
                </div><!-- row end -->
                    ...
                    <div class="col-md-12">
                        <div class="post-slide owl-carousel owl-theme owl-loaded" data-item="3" data-nav="false" data-dots="false" data-auto="false">
                            ...
                            <div class="featured-imagebox featured-imagebox-post top-image style2 box-shadow">
                                ...
                                <div class="featured-content text-left box-shadow"><!-- featured-content -->
                                    <div class="post-title featured-title">
                                        <h5><a href="single-blog.php">The 9 Best Construction Guides of 2021</a></h5>
                                    </div>
                                    <div class="post-meta pb-15"><!-- post-meta -->
                                    ...
                                    <a class="cmt-btn cmt-btn-size-sm cmt-icon-btn-right cmt-btn-color-darkgrey btn-inline" href="#">Read More<i class="ti ti-angle-right"></i></a>
