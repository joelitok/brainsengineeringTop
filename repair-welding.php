                                                ...
                                                <ul class="dropdown">
                                                   ...
                                                   <li class="active"><a href="#">Services</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="repair-welding.php">Repair Welding</a></li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box">
                            <div class="page-title-heading">
                                <h1 class="title">Repair Welding</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span><span>Repair Welding</span></span>
                            </div>
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                        ...
                        <div class="cmt-service-single-content-area">
                            <div class="post-featured-wrapper mb-40">
                                <div class="post-featured">
                                    <img class="img-fluid" src="images/blog/blog-06.jpg" alt="">
                                </div>
                            </div>
                            <div class="cmt-service-description">
                                <h4 class="mb-10">Repair Welding</h4>
                                <div class="mb-30">
                                ...
                                <h4 class="mb-10">Key Benefits</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-35">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut laboris nisi ut aliquip ex ea commodo consequat.</p>
                                            <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,&nbsp; dolore magnam aliquam quaerat voluptatem.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="cmt-list cmt-list-style-icon mb-35">
                                            ...
                                            <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Personalized Industrial Help</span></li>
                                            <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">The Easiest Way To Get What Need </span></li>
                                            <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Need It Fast? We Can Help.</span></li>
                                        </ul>
                                    </div>
