...
<body>
                                                ...
                                                <ul class="dropdown">
                                                   <li class="active"><a href="#">Home</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="home-4.php">Sample Homepage 4<span class="label-new">New</span></a></li>
            ...
            <div id="rev_slider_5_1" class="rev_slider fullwidthabanner" data-version="5.4.8.1">
                <ul>
                    ...
                    <li data-index="rs-4" data-transition="slotslide-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        data-y="['top','top','top','top']" data-voffset="['159','135','65','64']"
    ...
    <div class="site-main">
        ...
        <!--about-section-->
        <section class="cmt-row aboutus4-section clearfix">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-12">
                        <!-- cmt_single_image-wrapper -->
                        <div class="cmt_single_image-wrapper">
                            <img class="img-fluid" src="images/single-img-ten.png" alt="">
                        </div><!-- cmt_single_image-wrapper end -->
                        <div class="cmt-video-icon cmt-right-video-icon style1 ttm_prettyphoto mt-35 res-991-mt-30">
                            <div class="cmt-icon cmt-icon_element-fill cmt-icon_element-background-color-white cmt-icon_element-size-md cmt-icon_element-style-round mb-0">
                                <i class="flaticon flaticon-maintenance cmt-textcolor-skincolor"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="res-991-mt-30">
                            ...
                            <p>mercantile and feudal ecoan countries during the Industrial Revolution, mercantile and feudal economies.Thnomies.
                            </p>
                            <!-- row-->
                            <div class="row no-gutters mb-30 mt-30"><!-- row-->
                                <div class="col-sm-12">
                                    <ul class="cmt-list cmt-list-style-icon">
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Our power of choice is untrammelled.</span></li>
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Able to do what we like best</span></li>
                                        <li><i class="icon-ok-5 cmt-textcolor-skincolor"></i><span class="cmt-list-li-content"> The obligations of business holds.</span></li>
                                    </ul>
                                </div>
                            </div><!-- row end-->
                            <div class="separator">
                                <div class="sep-line solid"></div>
                            </div>
                            <!-- row-->
                            <div class="row no-gutters">
                                <div class="col-sm-6">
                                    <!--cmt-fid-->
                                    <div class="cmt-fid inside style3 cmt-fid-view-lefticon mb-0">
                                ...
                                <div class="col-sm-6">
                                    <!--featured-icon-box-->
                                    <div class="featured-icon-box style12 left-icon">
        ...
        <section class="cmt-row broken-section cmt-bgcolor-darkgrey clearfix">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-sm-12">
                        <div class="spacing-13">
                            <!-- section title -->
                            <div class="section-title clearfix">
                                <div class="title-header">
                            ...
                            <div class="row no-gutters mb-25 mt-25">
                    ...
                    <div class="col-lg-5">
                        <!-- cmt_single_image-wrapper -->
                        <div class="cmt_single_image-wrapper mt_45 mb_45 res-991-m-0">
                            <img class="img-fluid border-bottom-10 skin-border" src="images/single-img-eleven.png" alt="">
                        </div><!-- cmt_single_image-wrapper end -->
                        <div class="about-overlay-shape style3">
                            Build A Better Modern<br> Construction Please
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--service-section-->
        <section class="cmt-row service-section style4 bg-img13 clearfix">
            <div class="container">
                <div class="row"><!-- row -->
