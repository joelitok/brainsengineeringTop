                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                        <div class="widget widget_contact clearfix">
                            ...
                            <ul class="">
                                <li><i class="fa fa-map-marker"></i>Brain's engireening,<br>24h/24 st., DOUALA , CAMEROUN</li>
                                <li><i class="fa fa-envelope-o"></i>Email : <a href="#">vidalnwami@gmail.com</a></li>
                                <li><i class="fa fa-phone"></i>Phone : (+237) 675-985-291 <br>Support : +(+237) 694-391-158</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                        <div class="widget widget_text clearfix">
                           ...
                           <div class="">
                                <h3 class="widget_text_title cmt-textcolor-skincolor">675-985-291</h3>
