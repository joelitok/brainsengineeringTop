                                                   ...
                                                   <li><a href="#">Services</a>
                                                    ...
                                                    <li class="active"><a href="#">Projects</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="portfolio-single.php">Project Single</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">Blog</a>
                                                        <ul>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="cmt-featured-wrapper cmt-portfolio-featured-wrapper">
                                        <img class="img-fluid" src="images/portfolio/post-two.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="mt-40">
                                        <div class="cmt-portfolio-title">
                                            <h2 class="cmt-pf-detailbox-title">Project Details</h2>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mt-20">
                                                    <h4>Our Solutions</h4>
                                                    <p>If you are going to use a passage of Lorem Ipsum, you need to be sure elit.&nbsp;&nbsp;Ipsum generators on the Internet tend to repeat in some form, by injected humour,</p>
                                                    <!-- featured-icon-box -->
                                            ...
                                            <div class="col-lg-12">
                                                <p class="mb-40">All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.but the majority have suffered&nbsp;anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="cmt-pf-single-detail-box mt-50 pl-30 res-991-pl-0">
                                        <div class="cmt-portfolio-title">
