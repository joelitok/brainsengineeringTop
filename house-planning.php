                                                ...
                                                <ul class="dropdown">
                                                   ...
                                                   <li class="active"><a href="#">Services</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="house-planning.php">House Planning</a></li>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box">
                            <div class="page-title-heading">
                                <h1 class="title">House Planning</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span><span>House Planning</span></span>
                            </div>
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                    ...
                    <div class="col-lg-8 content-area order-1 order-lg-2">
                        ...
                        <div class="cmt-service-single-content-area">
                            ...
                            <div class="cmt-service-description">
                                <h4 class="mb-10">House Planning</h4>
                                <div class="mb-30">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="cmt_single_image-wrapper mb-35">
                                            <img class="img-fluid" src="images/blog/blog-04.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="cmt_single_image-wrapper mb-35">
