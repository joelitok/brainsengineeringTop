                        ...
                        <div class="cmt-service-single-content-area">
                            <div class="post-featured-wrapper mb-40">
                                <div class="post-featured">
                                    <img class="img-fluid" src="images/blog/blog-07.jpg" alt="">
                                </div>
                            </div>
                            <div class="cmt-service-description">
                                <h4 class="mb-10">Management</h4>
                                <div class="mb-30">
                                ...
                                <h4 class="mb-10">Why Is It Best?</h4>
                                <div class="mb-30">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur Sed ut perspiciatis.</p>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <!--featured-icon-box-->
                                        <div class="featured-icon-box left-icon style9 icon-align-top">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul class="cmt-list cmt-list-style-icon mb-35">
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">The Easiest Way To Get What Need </span></li>
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Need It Fast? We Can Help.</span></li>
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">We work to reduce air emissions</span></li>
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Personalized Industrial Help</span></li>
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">The Easiest Way To Get What Need </span></li>
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">Need It Fast? We Can Help.</span></li>
                                            <li><i class="fa fa-arrow-right cmt-textcolor-skincolor"></i><span class="cmt-list-li-content">We work to reduce air emissions</span></li>
                                        </ul>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="cmt_single_image-wrapper mb-35">
                                            <img class="img-fluid" src="images/blog/blog-05.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                                <h4 class="mb-10">Management Team</h4>
                                <div class="mb-30">
